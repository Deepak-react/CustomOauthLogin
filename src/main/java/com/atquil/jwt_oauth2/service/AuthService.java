...
//    Optional<UserInfoEntity> userInfoEntity= userInfoRepo.findByEmailId(authentication.getName());
//    log.info("UserInfoEntity:{}",userInfoEntity);
////    return createAuthenticationObject(userInfoEntity);
//}
//
//    private static Authentication createAuthenticationObject(Optional<UserInfoEntity> userInfoEntity) {
//        // Extract user details from UserDetailsEntity
//        String username = userInfoEntity.get().getEmailId();
//        log.info("Username:{}", username);
//        String password = userInfoEntity.get().getPassword();
//        String roles = userInfoEntity.get().getRoles();
//
